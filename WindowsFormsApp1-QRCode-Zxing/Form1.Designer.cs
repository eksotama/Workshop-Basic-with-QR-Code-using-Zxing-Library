namespace WindowsFormsApp1_QRCode_Zxing
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.textBox1.Size = new System.Drawing.Size(317, 68);
			...
			this.button1.Text = "สร้าง QR Code";
			...
			this.button2.Text = "อ่าน QR Code";
			...
			this.button3.Text = "เปิดภาพ QR Code";
			this.button3.UseVisualStyleBackColor = true;
			this.button3.Click += new System.EventHandler(this.button3_Click);
			// 
			// button4
			// 
			this.button4.Location = new System.Drawing.Point(164, 378);
